...
insert INTO block(block_name, transparent, gravity) Values(45,'Bricks', false, false);
insert INTO block(block_name, transparent, gravity) Values(17,'Oak Wood', false, false);
insert INTO block(block_name, transparent, gravity) Values(4,'Cobblestone', false, false);
insert INTO block(block_name, transparent, gravity) Values(1,'Stone', false, false);
insert INTO block(block_name, transparent, gravity) Values(77,'Stone Button', true, false);
insert INTO block(block_name, transparent, gravity) Values(64,'Oak Door', true, false);
insert INTO block(block_name, transparent, gravity) Values(85,'Oak Fence', true, false);
insert INTO block(block_name, transparent, gravity) Values(107, 'Oak Fence Gate', true, false);
insert INTO block(block_name, transparent, gravity) Values(18,'Oak Leaves', true, false);
insert INTO block(block_name, transparent, gravity) Values(5,'Oak Wood Planks', false, false);
insert INTO block(block_name, transparent, gravity) Values(70,'Stone Pressure Plate', true, false);
insert INTO block(block_name, transparent, gravity) Values(6,'Oak Sapling', true, false);
insert INTO block(block_name, transparent, gravity) Values(63,'Sign', true, false);
insert INTO block(block_name, transparent, gravity) Values(157,'Activator Rail', true, false);
insert INTO block(block_name, transparent, gravity) Values(37,'Dandelion', true, false);
insert INTO block(block_name, transparent, gravity) Values(53,'Oak Wood Stairs', true, false);
insert INTO block(block_name, transparent, gravity) Values(145,'Anvil', true, true);
insert INTO block(block_name, transparent, gravity) Values(138,'Beacon', true, false);
insert INTO block(block_name, transparent, gravity) Values(171,'White Carpet', true, false);
insert INTO block(block_name, transparent, gravity) Values(26,'Bed', true, false);
insert INTO block(block_name, transparent, gravity) Values(252,'White Concrete Powder', false, true);
insert INTO block(block_name, transparent, gravity) Values(20,'Glass', true, false);
insert INTO block(block_name, transparent, gravity) Values(35,'White Wool', false, false);
insert INTO block(block_name, transparent, gravity) Values(173, 'Block of Coal', false, false);
insert INTO block(block_name, transparent, gravity) Values(57,'Diamond Block', false, false);
insert INTO block(block_name, transparent, gravity) Values(133,'Emerald Block', false, false);
insert INTO block(block_name, transparent, gravity) Values(41,'Gold Block', false, false);
insert INTO block(block_name, transparent, gravity) Values(42,'Iron Block', false, false);
insert INTO block(block_name, transparent, gravity) Values(47,'Bookshelf', false, false);
insert INTO block(block_name, transparent, gravity) Values(81,'Cactus', true, false);
insert INTO block(block_name, transparent, gravity) Values(54,'Chest', true, false);
insert INTO block(block_name, transparent, gravity) Values(3,'Dirt', false, false);
insert INTO block(block_name, transparent, gravity) Values(2,'Grass', false, false);
insert INTO block(block_name, transparent, gravity) Values(24,'Sandstone', false, false);
insert INTO block(block_name, transparent, gravity) Values(61,'Furnace', true, false);
insert INTO block(block_name, transparent, gravity) Values(13,'Gravel', false, true);
insert INTO block(block_name, transparent, gravity) Values(168, 'Prismarine', false, false);
insert INTO block(block_name, transparent, gravity) Values(56, 'Diamond Ore', false, false);
insert INTO block(block_name, transparent, gravity) Values(9, 'Still Water', true, false);
insert INTO block(block_name, transparent, gravity) Values(79, 'Ice', true, false);
insert INTO block(block_name, transparent, gravity) Values(12,'Sand', false, true);
insert INTO block(block_name, transparent, gravity) Values(78, 'Snow', true, false);
