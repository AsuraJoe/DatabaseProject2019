	...
	public DataView getView(String n) {
		...
		if(mod==1) {
			...
			case "1":{
				...
				execute(proc);
				return new Inventory(mod,item_id,connection);
			}
			case "2":{
			...
			case "3": {
				System.out.println("Please enter the instance you want to enchant");
				return new ItemEnchantsView(mod,Integer.parseInt(mx.nextLine()),connection);
			}
			case "4": return reset();
			default: break;
			}
