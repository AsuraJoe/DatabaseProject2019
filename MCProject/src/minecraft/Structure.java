...
public class Structure extends DataView {
	...
	public Structure(int m, SQLConnector con) {
		preLoad();
		this.mod =m;
		this.connection = con;
	} 
	
	public Structure(SQLConnector con) {
		preLoad();
		this.connection = con;
	} 
	...
	public void preLoad() {
		// TODO Auto-generated method stub
		this.attrs = new String[]{"name","biome"};
		this.querry = ("select * from structure");
	...
	public DataView getView(String n) {
		...
		if(mod ==1) {
			...
			case "1":{
		        ...
		        proc+="');";
		        execute(proc);
				return new Structure(mod,connection);
			}
			case "2": {
